...
//레이아웃 인플레이트는 공식처럼 외우면 된다고 합니다!
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        lec_list = (ListView) getActivity().findViewById(R.id.list_lecture);
    ...
    public class Net extends AsyncTask<String,Void,String>
    {
        ...
        protected String doInBackground(String... arg0)
        {
            try {
                ...
                String link = "http://52.68.141.174/php/lecture.php?usCd=";
                link += usCd;
        ...
        protected void onPostExecute(String str)
        {
            ...
            lec_list.setAdapter(adapter);
            ((BaseAdapter)lec_list.getAdapter()).notifyDataSetChanged();

        }

        public void Parsing()
        {
            String link = "http://52.68.141.174/xml/lecture.xml";
